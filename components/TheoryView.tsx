      ...
      <div className="md:w-1/4 flex flex-col gap-2">
        ...
        {chapter.topics.map(topic => (
          <button
            ...
            className={`text-left p-4 rounded-xl text-sm font-bold transition-all ${selectedTopic?.id === topic.id ? 'bg-purple-900 text-white shadow-lg' : 'bg-white text-gray-600 hover:bg-purple-50'}`}
          >
            {topic.title}
          </button>
        ))}
