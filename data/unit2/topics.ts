...
export const topics: TheoryTopic[] = [
    ...
    },
    {
      ...
      content: [
        ...
        'Fatigue Study: Determining amount and frequency of rest intervals.',
        'Differential Piece Wage System: Paying higher rates to efficient workers and lower rates to inefficient ones.'
      ],
      visualizations: [
        {
    ...
    },
    {
      ...
      content: [
        ...
        '4. Unity of Command: One subordinate should receive orders from only ONE superior.',
        ...
        '9. Scalar Chain: Chain of authority from top to bottom. "Gang Plank" for emergency direct contact.',
