...
export const sqp: SQPQuestion[] = [
  ...
  },
  {
    ...
    answer: `Earning after tax = ₹  24,50,000 Interest= 50,00,000 x7/100 = ₹. 3,50,0000 Let the Earning before tax (EBT) = x EBT- Tax= EAT X-0.30 x= 24,50,000 0.70 x = 24,50,000 x= 24,50,000/0.70 x= 35,00,000 Earning before tax = ₹. 35,00,000 EBIT = Earning before tax + Interest =  35,00,000 + 3,50,000 =   ₹. 38,50,000 ROI= EBIt/total Investment  ×  100= 38,50,000 / 1,20,00,000 × 100 = 32.08% As ROI (32.08%) > Rate of interest (7%).  The company can choose to use trading on equity  to increase its EPS. The finance manager was justified in making this recommendation.`,
